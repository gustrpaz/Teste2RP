...
export const usuarioAutenticado = () => localStorage.getItem('teste2rp-chave-autenticacao') !== null;
...
export const parseJwt = () => {
    ...
    let base64 = localStorage.getItem('teste2rp-chave-autenticacao').split('.')[1];
